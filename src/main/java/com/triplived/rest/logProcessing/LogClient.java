...
public List<String> execCommandAndGetLogs(String fromTime, String toTime, String deviceId) {
    ...
    try {
        ...
        String command = "sh /home/triplived/testScript.sh" + " '" + fromTime + "'" + " '" + toTime + "'" + " '" + deviceId + "'";
