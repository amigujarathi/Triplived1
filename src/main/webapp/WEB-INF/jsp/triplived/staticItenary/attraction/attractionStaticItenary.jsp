...
<div class="container">
      ...
      <div class="row page-header">
        <div class="col-lg-6">
          <h1>Tell us about attraction !!</h1>
        </div>
         <div class="col-lg-6">
      ...
      <div class="row page-header" style="padding-top:10px;padding-bottom: 10px">
        <div class="col-lg-12">
          <div class="col-lg-12" style="padding-top:30px;" id="optionsId">
          	<div class="row">
          		<div class="col-lg-4">
          			<button type="button" id="addAttractionId" class="btn btn-warning" onclick="loadAttractionScreen()">Add another attraction</button>
          		</div>
          		<div class="col-lg-4">
          			<button type="button" id="addHotelId" class="btn btn-warning" onclick="loadHotelScreen()">Add hotel</button>
          		</div>		
          		<div class="col-lg-4">
      ...
      <div class="row" style="padding-top:10px;padding-bottom: 10px">
            ...
            <div class="row" id="smsgs"><!--   FF/CC --></div>
	            <div class="row">
	              <div class="form-group required col-lg-6" >
	                ...
	                <input class="control-label form-control"  name="cityname1" id="cityname1" value="${cityName}" disabled/>
		         ...
		         <div class="row">
	               <div class="form-group required col-lg-6" id = "timeStampDiv" >
	                <label  class="control-label"for="longitude">Time</label><br/>
	               ...
	               <div class="form-group required col-lg-6" id="ratingParentId">
	                <label class="control-label"  for="email">Attraction Rating</label>
	                <select required="required" class="typeahead form-control " id="attractionRating" name="attractionRating">
         ...
         <div class="col-lg-6">
         	<div class="row">
	              <div class="form-group required col-lg-12">
	                <label class="control-label"  for="message">Attraction Reviews</label>
	                <textarea placeholder="One of Two liner about the attraction" name="attractionDescription" class="form-control" rows="2" id="message"></textarea>
	              </div>
	        </div>
        ...
        <div class="col-lg-12" style="padding-top:3px">
        	<div class="form-group col-lg-12">
					<div class="row fileupload-buttonbar">
						<div class="col-lg-7">
			                ...
			                <div class="btn btn-success fileinput-button" id="uploadPhotoId">
			                    ...
			                    <span id="addPhotosId">Add Photos of attraction...</span>
			                    <input type="file" name="fileToUpload" multiple=>
			                </div>
			              
			                <span style="border-right: 2px solid red; margin:12px"></span>
			                <button id="submitBtnId" type="submit" class="btn btn-primary start" onclick="submitForm()">
			                    <i class="glyphicon glyphicon-upload"></i>
			                    <span>Submit</span>
			                </button>
					...
					<label>Please select all photos of this attraction for upload in one go. No more file uploads for this attraction would be allowed after that.</label>
